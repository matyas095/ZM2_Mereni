...
class FormatTable(Method):
    ...
    def get_args_info(self):
        return [
            ...
            {
                "flags": ["--caption"],
                "help": "Nahradí caption",
                "required": False,
                "type": str
            },
            {
                "flags": ["--label"],
                "help": "Nahradí label (bez tab: prefix)",
                "required": False,
                "type": str
            },
            {
    ...
    def _apply_auto_scale(self, headers, rows, dec_sep):
        ...
        from objects.units import parse_tex_header, format_tex_header, auto_scale_exponent, PREFIX_FOR_EXPONENT, parse_unit, convert_str_value;
